from LaberintoGUI import LaberintoGUI
...
from test_lab2Hab1Tienda4Entes import test_lab2Hab1Tienda4Entes
from test_lab2Hab2Arm2Baul1Tienda2Entes import Test
from test_lab2HabHorizontal1Tienda import Test
from test_lab3Hab1Baul2Tiendas4Entes import Test
from test_lab3Hab2Arm1Tienda6Entes import Test
from test_lab4Hab4Arm1Baul4Entes import Test
from test_lab4Hab4Arm1Tienda4Entes import Test
from test_lab4Hab4Arm2Baul5Entes import Test
from test_lab4Hab4Arm2Tiendas5Entes import Test
from test_lab4Hab4Arm3Baul1Tienda4Entes import Test
from test_lab4Hab4Arm4BichosTunelRombo import Test


while True:
    opcion = input(Fore.MAGENTA+"¿Qué opción quieres elegir?\n"+Style.RESET_ALL+"1. Jugar desde la consola\n2. Jugar desde la GUI\n3. Salir\n")
    try:
        opcion = int(opcion)
        if opcion == 1:
            while True:
                ...
                try:
                    ...
                    if metodo == 1:
                        ...
                        switch = {
                            ...
                            6: 'laberintos/lab4Hab4Arm1Baul4Entes.json',
                    ...
                    while juego.fase.esFinal() == False:
                        if activado:
                            if abierto:
                                operacion = input(Fore.MAGENTA+"\n¿Qué quieres hacer?\n"+Fore.RED+"0. Atacar\n"+Fore.LIGHTBLUE_EX+"1. Desactivar Todas Las Bombas\n2. Cerrar Todas Las Puertas\n"+Fore.LIGHTGREEN_EX+"3. Lanzar Hilos\n4. Terminar Hilos\n"+Fore.LIGHTWHITE_EX+"5. Añadir personaje\n6. Entrar en tunel\n"+Fore.YELLOW+"7. Abrir Puerta\n"+Fore.CYAN+"8. Mover personaje\n"+Fore.LIGHTMAGENTA_EX+"9. Entrar a la tienda\n"+Fore.YELLOW+"10. ¿Qué puedo hacer en esta posición?\n11. ¿Qué tengo en el inventario?\n"+Fore.LIGHTMAGENTA_EX+"12. Mostrar estado actual del laberinto\n"+Fore.WHITE+"13. Salir\n"+Style.RESET_ALL)
                            else:
                        ...
                        try:
                            ...
                            if operacion == 0:
                                        ...
                                        if hijo.esTienda():
                                            ...
                                            while juego.personaje.posicion == hijo:
                                                ...
                                                if accion == 1:
                                                    ...
                                                    obj = int(obj)
                                                    if obj-1 <len(comprar) and comprar[obj-1] == True:
                                                        ...
                                                        print("No tienes suficiente dinero o no existe el objeto en la tienda")
                                ...
                                if juego.personaje is not None:
                                    objSeleccionado = None
                                    for i, objeto in enumerate(juego.personaje.inventario.objetos):
                                        print(str(i+1)+". "+str(objeto))
                                    accion = input("¿Que objeto quieres seleccionar?\n")
                                    accion = int(accion)
                                    objSeleccionado = list(juego.personaje.inventario.objetos.keys())[accion-1]
                                    print("Objeto seleccionado: ",objSeleccionado)
                                    if objSeleccionado is not None:
                                        comandos =  objSeleccionado.obtenerComandos(juego.personaje)
                                        for i, comando in enumerate(comandos):
                                            print(str(i+1)+". "+str(comando))
                                        accion = input("¿Que comando quieres ejecutar?\n")
                                        accion = int(accion)
