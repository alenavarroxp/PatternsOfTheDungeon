...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        unArchivo = os.path.join(directorio_proyecto, "laberintos/lab3Hab2Arm1Tienda6Entes.json")
        director = Director()
    ...
    def testBichos(self):
        ...
        for bicho in self.juego.bichos:
            ...
            if bicho.esAgresivo():
                bichoAgresivo+=1
        self.assertEqual(bichoPerezoso, 3)
        print("Hay 3 bichos perezosos: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
