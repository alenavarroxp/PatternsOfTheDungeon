...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        unArchivo = os.path.join(directorio_proyecto, "laberintos/lab2HabHorizontal1Tienda.json")
        director = Director()
    ...
    def testHabitaciones(self):
        ...
        if isinstance(hab1.forma,Cuadrado):
            ...
            self.assertEqual(hab1.forma.sur.esPared(),True)
            print("El sur de la habitación 1 es pared: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
        ...
        if isinstance(hab2.forma,Cuadrado):
            ...
            print("El norte de la habitación 2 es pared: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
            self.assertEqual(hab2.forma.este.esPared(),True)
            print("El este de la habitación 2 es pared: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
            self.assertEqual(hab2.forma.sur.esPared(),True)
            print("El sur de la habitación 2 es pared: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
            self.assertEqual(hab2.forma.oeste.esPared(),False)
            print("El oeste de la habitación 2 no es pared: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
            self.assertEqual(hab2.forma.oeste.esPuerta(),True)
            print("El oeste de la habitación 2 es puerta: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
    ...
    def testBichos(self):
        ...
        for bicho in self.juego.bichos:
            ...
            if bicho.esAgresivo():
                bichoAgresivo+=1
        self.assertEqual(bichoPerezoso, 1)
        print("Hay 1 bichos perezosos: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
        self.assertEqual(bichoAgresivo, 1)
        print("Hay 1 bichos agresivos: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
