...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        unArchivo = os.path.join(directorio_proyecto, "laberintos/lab3Hab1Baul2Tiendas4Entes.json")
        director = Director()
    ...
    def testIniciales(self):
        ...
        self.assertEqual(len(self.juego.laberinto.hijos), 3)
    ...
    def testHabitaciones(self):
        ...
        if isinstance(hab1.forma,Cuadrado):
            ...
            print("El este de la habitación 1 es pared: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
        ...
        if isinstance(hab3.forma,Cuadrado):
            ...
            print("El sur de la habitación 3 es pared: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
    ...
    def testHechiceros(self):
        ...
        print("Hay 2 hechicero mago: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
