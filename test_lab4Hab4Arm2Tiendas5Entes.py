...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        unArchivo = os.path.join(directorio_proyecto, "laberintos/lab4Hab4Arm2Tiendas5Entes.json")
        director = Director()
    ...
    def testBichos(self):
        ...
        self.assertEqual(len(self.juego.bichos), 3)
        print("Hay 3 bichos: ",Fore.GREEN+"Correct"+ Style.RESET_ALL)
